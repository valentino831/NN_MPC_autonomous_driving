...
/* Custom Type definition for MATLAB Function: '<S1>/MPC_cntr' */
...
#ifndef struct_tag_gWKNvmktqDzV9eqO01xLvG
#define struct_tag_gWKNvmktqDzV9eqO01xLvG

struct tag_gWKNvmktqDzV9eqO01xLvG
{
  BusActors2 contents;
};

#endif                                 /*struct_tag_gWKNvmktqDzV9eqO01xLvG*/

#ifndef typedef_captured_var_5_control_system_T
#define typedef_captured_var_5_control_system_T

typedef struct tag_gWKNvmktqDzV9eqO01xLvG captured_var_5_control_system_T;
...
/* Custom Type definition for MATLAB Function: '<S1>/MPC_cntr' */
#ifndef struct_tag_ojHXb6zi3pWKug5jJoyGVC
#define struct_tag_ojHXb6zi3pWKug5jJoyGVC

struct tag_ojHXb6zi3pWKug5jJoyGVC
{
  captured_var_10_control_syste_T *f1;
  captured_var_1_control_system_T *f2;
  captured_var_9_control_system_T *f3;
...
#endif                                 /*struct_tag_ojHXb6zi3pWKug5jJoyGVC*/

#ifndef typedef_cell_11_control_system_T
#define typedef_cell_11_control_system_T

typedef struct tag_ojHXb6zi3pWKug5jJoyGVC cell_11_control_system_T;
...
#ifndef struct_tag_l64OlGlAUwaD0oicbjdsvG
#define struct_tag_l64OlGlAUwaD0oicbjdsvG

struct tag_l64OlGlAUwaD0oicbjdsvG
{
  cell_11_control_system_T tunableEnvironment;
};

#endif                                 /*struct_tag_l64OlGlAUwaD0oicbjdsvG*/

#ifndef typedef_anonymous_function_control_sy_T
#define typedef_anonymous_function_control_sy_T

typedef struct tag_l64OlGlAUwaD0oicbjdsvG anonymous_function_control_sy_T;

#endif                               /*typedef_anonymous_function_control_sy_T*/

/* Custom Type definition for MATLAB Function: '<S1>/MPC_cntr' */
#ifndef struct_tag_V8PhwNvmdz44GhyEMtkNRC
#define struct_tag_V8PhwNvmdz44GhyEMtkNRC

struct tag_V8PhwNvmdz44GhyEMtkNRC
{
...
#endif                                 /*struct_tag_V8PhwNvmdz44GhyEMtkNRC*/

#ifndef typedef_s_V8PhwNvmdz44GhyEMtkNRC_cont_T
#define typedef_s_V8PhwNvmdz44GhyEMtkNRC_cont_T

typedef struct tag_V8PhwNvmdz44GhyEMtkNRC s_V8PhwNvmdz44GhyEMtkNRC_cont_T;

#endif                               /*typedef_s_V8PhwNvmdz44GhyEMtkNRC_cont_T*/

#ifndef struct_tag_WHb3Bhe42BkO79ZCb3EKmD
#define struct_tag_WHb3Bhe42BkO79ZCb3EKmD

struct tag_WHb3Bhe42BkO79ZCb3EKmD
{
  anonymous_function_control_sy_T objfun;
...
#endif                                 /*struct_tag_WHb3Bhe42BkO79ZCb3EKmD*/

#ifndef typedef_s_WHb3Bhe42BkO79ZCb3EKmD_cont_T
#define typedef_s_WHb3Bhe42BkO79ZCb3EKmD_cont_T

typedef struct tag_WHb3Bhe42BkO79ZCb3EKmD s_WHb3Bhe42BkO79ZCb3EKmD_cont_T;

#endif                               /*typedef_s_WHb3Bhe42BkO79ZCb3EKmD_cont_T*/
...
#ifndef struct_tag_DIUH763spfu381n7IeysAG
#define struct_tag_DIUH763spfu381n7IeysAG

struct tag_DIUH763spfu381n7IeysAG
{
  boolean_T IsLoop;
  real_T RoadWidth;
  real_T DistanceTraveled[640];
  ...
  real_T k0[1011];
  real_T k1[1011];
  real_T vppBreaks[1012];
  real_T vppCoefs[4044];
  real_T vppPieces;
  real_T vppOrder;
  real_T vppDim;
  real_T bppBreaks[1012];
  real_T bppCoefs[4044];
  real_T bppPieces;
  real_T bppOrder;
  real_T bppDim;
  ...
  real_T RoadTileVertices[7668];
  real_T RoadTileCentroids[1917];
  boolean_T RoadTileHasLaneMarking[639];
  real_T RoadTileLaneSpecIdx[639];
...
#endif                                 /*struct_tag_DIUH763spfu381n7IeysAG*/

#ifndef typedef_s_DIUH763spfu381n7IeysAG_cont_T
#define typedef_s_DIUH763spfu381n7IeysAG_cont_T

typedef struct tag_DIUH763spfu381n7IeysAG s_DIUH763spfu381n7IeysAG_cont_T;

#endif                               /*typedef_s_DIUH763spfu381n7IeysAG_cont_T*/

#ifndef struct_tag_yxfXU18PThqrJvsBmEDJOC
#define struct_tag_yxfXU18PThqrJvsBmEDJOC

struct tag_yxfXU18PThqrJvsBmEDJOC
{
